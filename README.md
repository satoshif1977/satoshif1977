# Satoshi Fujimura（さといも）

クラウドエンジニアへの転身を目指し、ポートフォリオ構築に取り組んでいます。
...
**Claude Cowork** を日常的に活用し、技術調査・設計相談・ドキュメント作成を AI との協働で進めています。
Terraform / Python / AWS に特化した**カスタム Skills** を設定・継続的に更新し、自分のワークフローに最適化しています。
...
![Claude Cowork](https://img.shields.io/badge/Claude%20Cowork-blueviolet?style=flat&logo=anthropic&logoColor=white)
![Claude Skills](https://img.shields.io/badge/Custom%20Skills-green?style=flat&logo=anthropic&logoColor=white)

| カテゴリ | 技術 |
|---------|------|
| IaC | Terraform（モジュール構成・CI/CD 連携）/ AWS CDK（TypeScript） |
...
| リポジトリ | 概要 |
|-----------|------|
| [aws-ecs-bedrock-chat](https://github.com/satoshif1977/aws-ecs-bedrock-chat) | ECS Fargate + Bedrock（Claude Haiku 4.5）チャットアプリ。DynamoDB 履歴永続化・RAG モード・GitHub Actions CI/CD 付き<br>![Demo](https://github.com/satoshif1977/aws-ecs-bedrock-chat/raw/master/docs/demo/demo.gif) |
| [aws-bedrock-agent](https://github.com/satoshif1977/aws-bedrock-agent) | Bedrock Agent + Action Groups で FAQ 自動応答を実装。Streamlit Web UI から直接 Invoke |
...
| [aws-bedrock-knowledgebase-rag](https://github.com/satoshif1977/aws-bedrock-knowledgebase-rag) | Bedrock Knowledge Bases × OpenSearch Serverless でネイティブ RAG を実装。Titan Embed v2 + Claude 3 Haiku |
| [aws-multimodal-analysis](https://github.com/satoshif1977/aws-multimodal-analysis) | S3 → Bedrock Claude → DynamoDB の業務文書自動解析パイプライン。請求書・見積書の自動データ化 PoC |
| [aws-step-functions-bedrock](https://github.com/satoshif1977/aws-step-functions-bedrock) | Step Functions + Bedrock SDK 統合によるサーバーレス AI ワークフロー。条件分岐で回答を自動切り替え |
...
| [aws-cdk-3tier-app](https://github.com/satoshif1977/aws-cdk-3tier-app) | Terraform 版と同構成を AWS CDK（TypeScript）で実装。CDK Assertions によるユニットテスト 18 項目付き |
...
| リポジトリ | 概要 |
|-----------|------|
| [gas-business-automation-hub](https://github.com/satoshif1977/gas-business-automation-hub) | Google Apps Script × Gemini AI で期限管理・フォーム振り分け・レビュー分析を全自動化 |
