...
| リポジトリ | 概要 |
|-----------|------|
| [aws-ecs-bedrock-chat](https://github.com/satoshif1977/aws-ecs-bedrock-chat) | ECS Fargate + Bedrock（Claude Haiku 4.5）チャットアプリ。DynamoDB 履歴永続化・RAG モード・GitHub Actions CI/CD 付き |
